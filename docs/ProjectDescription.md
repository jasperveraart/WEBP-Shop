...
A written **report** must be included with the submission.The report must contain:
...
- Submit a **ZIP file** named: PracticalWork_WebProgramming_A_FirstName1_LastName1_FirstName2_LastName2.zip
- The ZIP must contain:
- All **source code** of the solution.
- The **database file** (LocalDB `.mdf`).
- All **images used**.
- The **report** in PDF format.
- Submission is done via **Moodle**.
- **Deadline:** December 14th, 2025 (Saturday).
...
- All three apps must share the **same database**.
- Each pair must be able to **compile and run** all apps during defense.
- **Code copying** or **AI-generated work without adaptation** is not allowed.
...
- The system must be **fully functional** and **consistent** across all apps.
...
- Remember: this is an **academic project**, not a production system — focus on **completeness**, **correct logic**, and **clarity** of your implementation.
